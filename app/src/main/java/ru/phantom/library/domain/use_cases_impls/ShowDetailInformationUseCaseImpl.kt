...
class ShowDetailInformationUseCaseImpl @Inject constructor() : ShowDetailInformationUseCase {
    override operator fun invoke(element: BasicLibraryElement) : DetailState {
