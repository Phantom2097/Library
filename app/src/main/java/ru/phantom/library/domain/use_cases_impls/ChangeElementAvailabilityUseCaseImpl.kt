 ...
 */
class ChangeElementAvailabilityUseCaseImpl @Inject constructor(
    override val repository: ItemsRepository<BasicLibraryElement>
) : ChangeElementAvailabilityUseCase{
    override suspend operator fun invoke(position: Int, element: BasicLibraryElement): BasicLibraryElement {
